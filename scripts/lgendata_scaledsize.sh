...
if [[ $# -lt 4 ]]; then
  echo "Usage: ./lgendata_scaledsize.sh size_spec num_events num_users split_nums [ batches=1 ] [ keep_only=-1 ] [ partitioned=false ] [ alpha=2.0 ]"
  echo "e.g.: ./lgendata_scaledsize.sh 5m-each 5000000 100000 \"1 2 4 8 16 32\" 1 1 true 2.0"
