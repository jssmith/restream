...
#  e.g.: ./lgendata.sh 5m-each 5000000 100000 "1 2 4 8 16 32" 1
#        
...
if [[ $# -lt 4 ]]; then
  echo "Usage: ./lgendata.sh size_spec num_events num_users split_nums [ keep_only=-1 ]"
  echo "e.g.: ./lgendata.sh 5m-each 5000000 100000 \"1 2 4 8 16 32\" 1"
