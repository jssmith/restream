 ...
 *
 */
class MessageCountThresholdSpamDetectorSpec extends FlatSpec with TestRunner {

  it should "run with a two-way split" in {
    runDistributedSpamDetector(2, classOf[MessageCountThresholdSpamDetectorStats], DataDesc.SHORT)
  }
